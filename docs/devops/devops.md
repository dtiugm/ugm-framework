DevOps adalah seperangkat praktik, budaya, dan filosofi yang mengotomatiskan dan mengintegrasikan proses antara tim pengembangan perangkat lunak (Development) dan tim operasi TI (Operations).
